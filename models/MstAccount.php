...
class MstAccount extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    {
        return [
            //[['account_type', 'username', 'password', 'auth_key', 'first_name', 'middle_name', 'last_name', 'address', 'contact_no', 'notify', 'notify_conact_no', 'assignment', 'next_assignment', 'status', 'creator_id', 'updater_id'], 'required'],
