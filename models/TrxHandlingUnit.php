...
class TrxHandlingUnit extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['transaction_id', 'customer_code', 'inbound_no', 'pallet_no', 'plant_location', 'storage_location', 'packaging_code', 'pallet_weight', 'transfer_order', 'storage_type', 'storage_section', 'storage_bin', 'inbound_status', 'creator_id', 'updater_id'], 'required'],
